...
Replace `path_to_input.o` with your the object file you want to disassemble, and `path_to_output.txt` with the file you want the disassembly to be written to.

```
DeACC disassemble -o path_to_output.txt path_to_input.o
```

If building DeACC yourself from source, you can also do:
```
dotnet run --project DeACC\DeACC.csproj disassemble -o path_to_output.txt path_to_input.o
```